...
<form  id="recovery_form" action="<?php echo vendor_url('authentication/forgot_password') ?>" method="POST">
	<div class="panel panel-body login-form">
		<div class="text-center">
			...
			<h5 class="content-group">Forgot Password<small class="display-block">Forgot password instructions</small></h5>
		</div>
		...
		<a href="<?php echo vendor_url('authentication') ?>">Login</a>
