			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li><a href="<?php echo base_url('admin/profile/edit'); ?>" >Edit Profile</a></li>
						<li><a href="<?php echo admin_url('authentication/logout'); ?>" >Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
							...
							<div class="media">
								<div class="media-body">
									<span class="media-heading text-semibold">
										Welcome&nbsp<?php echo get_loggedin_info('username').'&nbsp;'; ?>
										<a style="color: white;" href="<?php echo admin_url('authentication/logout'); ?>" align="padding-right"><i class="icon-switch2" data-popup="tooltip" data-placement="top"  title="Logout"></i></a>
									</span>
								</div>
							</div>
						</div>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li
									...
									?>
									>
									<a href="<?php echo base_url('admin/store'); ?>"><i class="icon-eye4"></i> <span>Visit Your Store</span></a>
								</li>
								<!-- home link -->
								<li
									<?php
